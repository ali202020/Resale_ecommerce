...
<body>
	<div class="header">
		<div class="container">
			<div class="logo">
				<a href="{{ route('main') }}"><span>Re</span>sale</a>
			</div>
	...
	<div class="main-banner banner text-center">
	  <div class="container">    
			...
			<a href="{{route('create_ad')}}">Post Free Ad</a>
	  </div>
	</div>
		<!-- content-starts-here -->
		<div class="content">
			<div class="categories">
				<div class="container">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab2">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab3">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab4">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab5">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab6">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab7">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab8">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab9">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab10">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab11">
							<div class="focus-border">
								<div class="focus-layout">
					...
					<div class="col-md-2 focus-grid">
						<a href="{{route('categories')}}#parentVerticalTab12">
							<div class="focus-border">
								<div class="focus-layout">
