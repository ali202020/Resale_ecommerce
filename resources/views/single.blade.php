		...
		<div class="container">
			...
			<div class="product-desc">
				<div class="col-md-7 product-view">
					<h2>{{$Mobile->ad_title}}</h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i><a href="#">state</a>, <a href="#">city</a>| Added at {{$Mobile->created_at}}, Ad ID: {{$Mobile->id}}</p>
					<div class="flexslider">
						<ul class="slides">
							
								<img src="images/{{$Mobile->ad_image}}')" />
					...
					<div class="product-details">
						...
						<p><strong>Summary</strong> : {{$Mobile->ad_description}}</p>
				...
				<div class="col-md-5 product-details-grid">
					<div class="item-price">
						<div class="product-price">
							...
							<h3 class="rate">{{$Mobile->ad_price}}</h3>
					...
					<div class="interested text-center">
						...
						<p><i class="glyphicon glyphicon-earphone"></i>{{$Mobile->user_phone}}</p>
					</div>
						<div class="tips">
